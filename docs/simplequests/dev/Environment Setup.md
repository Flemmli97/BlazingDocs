...
dependencies {    
    compileOnly("io.github.flemmli97:simplequests_api:${minecraft_version}-${mod_version}-common")
}
```
...
dependencies {    
    compileOnly("io.github.flemmli97:simplequests_api:${minecraft_version}-${mod_version}-${mod_loader}")
}
```
...
dependencies {
    modCompileOnly("io.github.flemmli97:simplequests_api:${minecraft_version}-${mod_version}-fabric")
}
```
