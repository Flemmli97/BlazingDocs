...
The quests are defined via datapacks.

You can see an example of a quest datapack under https://github.com/Flemmli97/SimpleQuests/tree/HEAD/Example-Datapack
Or in any other version branch under `./Example-Datapack`

It is recommended to use the datapack generator under https://flemmli97.github.io/misode.github.io/ (based on [this](https://github.com/misode/misode.github.io))
which makes the whole process trivial.  
Then go to `Modded Generators -> Quests or Quest Category`

Report bugs with custom generators under https://github.com/Flemmli97/misode.github.io!
