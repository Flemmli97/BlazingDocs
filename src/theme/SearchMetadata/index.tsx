  ...
  return (
    <Head>
      ...
      */}
      ...
      {/* MeiliSearch DocSearch metadata */}
      {language && <meta name="docs-scraper:language" content={language} />}
      {version && <meta name="docs-scraper:version" content={version} />}
      {tag && <meta name="docs-scraper:docusaurus_tag" content={tag} />}
    </Head>
  );
}
